        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameQuestions_AspNetUsers_WinnerId",
                        column: x => x.WinnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsWinningAnswer = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerAnswers_AnswerOptions_AnswerOptionId",
                        column: x => x.AnswerOptionId,
                        principalTable: "AnswerOptions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PlayerAnswers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlayerAnswers_GameQuestions_GameQuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameQuestions_WinnerId",
                table: "GameQuestions",
                column: "WinnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerAnswers_AnswerOptionId",
                table: "PlayerAnswers",
                column: "AnswerOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerAnswers_GameQuestionId",
                table: "PlayerAnswers",
                column: "GameQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerAnswers_UserId",
                table: "PlayerAnswers",
                column: "UserId");
